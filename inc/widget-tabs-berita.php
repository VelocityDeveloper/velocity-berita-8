<?php
/**
 * WIDGET TABS BERITA 3
 */
if (!defined('ABSPATH')) {
	exit; // Exit if accessed directly.
}

class Tabs_Berita_3_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
            'tabs_berita_3_widget',
            __('Tabs Berita 3', 'velocity'),
            array( 'description' => __( 'Menampilkan tabs template berita 3', 'velocity' ), )
        );
    }
...
function register_tabs_berita_3_widget() {
    register_widget( 'Tabs_Berita_3_Widget' );
}
add_action( 'widgets_init', 'register_tabs_berita_3_widget' );